...
class TestMaskUrl:
    def test_bark_short_key_masked(self):
    ...
    def test_query_token_dropped(self):
...
class TestDingtalk:
    def test_at_mobiles_omitted_when_number_none(self):
    ...
    def test_at_mobiles_included_when_number_given(self):
        captured: dict[str, object] = {}
