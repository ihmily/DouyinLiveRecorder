...
def _get_coverage_json(data_file: str | None) -> dict:
    ...
    if result.returncode != 0:
        print(f"ERROR: coverage json failed:\n{result.stderr}")
        sys.exit(2)
...
def _find_module_coverage(coverage_data: dict, module_path: str) -> dict | None:
...
def main() -> None:
    ...
    sys.exit(check_coverage(data_file=args.data_file))
